...
public class CourseDAO{
    ...
    public ArrayList<Course> getAll(String loginName) {
        ...
        ArrayList<ArrayList<String>> tableList = sql.readQuery("Course", loginName,query);
    ...
    public void updateCourse(String courseName,String column, String changeInto,String loginName) {
        String query = "UPDATE Course SET " + column + "= '" + changeInto +"' WHERE Name = '" + courseName + " ' ";
        sql.updateQuery("Course", loginName,query);
    }
